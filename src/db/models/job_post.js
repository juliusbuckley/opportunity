module.exports = (sequelize, DataTypes) => {
  var jobPost = sequelize.define('jobPost', {
    ...
    jobStatus: DataTypes.ENUM('Created', 'Pending Approval', 'Approved', 'Sourcing', 'Interview', 'Offer',
      'Filled', 'Cancelled')
  }, {
    classMethods: {
      associate: function(models) {
        ...
        jobPost.belongsTo(models.industry, {
          allowNull: false
        })
        ...
        jobPost.belongsToMany(models.question, {
